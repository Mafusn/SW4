...
class ParserTest {
    ...
    void AssignIntTest() throws FileNotFoundException {
        ...
        // [GIVEN] That we create the expected AST from the code from the file
        Prog expectedAST = new Prog();
        Assigning intAssign = new Assigning("a", new Id("a"), new IntNum("5"));
        Assigning intAssign2 = new Assigning("b", new Id("b"), new IntNum("10"));
    ...
    void AssignIntWithExprTest() throws FileNotFoundException {
        ...
        Assigning intAssign = new Assigning("a", new Id("a"), computingA6);
        Assigning intAssign2 = new Assigning("b",new Id("b"), computingB1);
        Assigning intAssign3 = new Assigning("c",new Id("c"), computingC1);
    ...
    void AssignFloatWithExprTest() throws FileNotFoundException {
        ...
        Assigning floatAssign = new Assigning("a", new Id("a"), computingA6);
        Assigning floatAssign2 = new Assigning("b",new Id("b"), computingB1);
        Assigning floatAssign3 = new Assigning("c",new Id("c"), computingC1);
    ...
    void AssignBoolWithExprTest() throws FileNotFoundException {
        ...
        BinOperator binOperatorA2 = new BinOperator("&&", new Bool("true"), new Not(new Id("x")));
        ...
        Assigning boolAssign = new Assigning("a", new Id("a"), binOperatorA3);
        Assigning boolAssign2 = new Assigning("b",new Id("b"), binOperatorB1);
        Assigning boolAssign3 = new Assigning("c",new Id("c"), binOperatorC1);
        Assigning boolAssign4 = new Assigning("d",new Id("d"), binOperatorD2);
        Assigning boolAssign5 = new Assigning("e",new Id("e"), binOperatorE7);
